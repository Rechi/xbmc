  ...
  case CONTEXT_BUTTON_PLAY_WITH:
    {
      ...
      if (!player.empty())
      {
        ...
        VideoSelectAction selectAction = static_cast<VideoSelectAction>(CServiceBroker::GetSettingsComponent()->GetSettings()->GetInt(CSettings::SETTING_MYVIDEOS_SELECTACTION));
