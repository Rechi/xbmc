...
std::shared_ptr<CSettingBool> CGUIDialogSettingsManualBase::AddToggle(const SettingGroupPtr& group,
                                                                      ...
                                                                      int help /* = -1 */)
{
  if (group == nullptr || id.empty() || label < 0 || GetSetting(id) != nullptr)
    return nullptr;
...
std::shared_ptr<CSettingString> CGUIDialogSettingsManualBase::AddSpinner(
    ...
    int help /* = -1 */)
{
  if (group == nullptr || id.empty() || label < 0 || filler == NULL || GetSetting(id) != nullptr)
    return nullptr;
...
std::shared_ptr<CSettingInt> CGUIDialogSettingsManualBase::AddSpinner(
    ...
    int help /* = -1 */)
{
  if (group == nullptr || id.empty() || label < 0 || entries.empty() || GetSetting(id) != nullptr)
    return nullptr;
