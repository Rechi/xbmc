...
/* Getting value of field for current record */
  virtual field_value get_field_value(const char* f_name);
  virtual field_value get_field_value(int index);
/* Alias to get_field_value */
  field_value fv(const char* f) { return get_field_value(f); }
  field_value fv(int index) { return get_field_value(index); }
