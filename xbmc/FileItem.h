...
public:
  ...
  bool IsInternetStream(bool bStrictCheck = false) const;
  ...
  inline bool HasEPGInfoTag() const { return m_epgInfoTag != NULL; }
  ...
  inline bool HasPVRRecordingInfoTag() const { return m_pvrRecordingInfoTag != NULL; }
