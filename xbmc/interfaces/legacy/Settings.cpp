...
bool Settings::getBool(const char* id) noexcept(false)
{
  bool value = false;
...
int Settings::getInt(const char* id) noexcept(false)
{
  int value = 0;
...
double Settings::getNumber(const char* id) noexcept(false)
{
  double value = 0.0;
...
String Settings::getString(const char* id) noexcept(false)
{
  std::string value;
...
std::vector<bool> Settings::getBoolList(const char* id) noexcept(false)
{
...
std::vector<int> Settings::getIntList(const char* id) noexcept(false)
{
...
std::vector<double> Settings::getNumberList(const char* id) noexcept(false)
{
...
std::vector<String> Settings::getStringList(const char* id) noexcept(false)
{
...
void Settings::setBool(const char* id, bool value) noexcept(false)
{
...
void Settings::setInt(const char* id, int value) noexcept(false)
{
...
void Settings::setNumber(const char* id, double value) noexcept(false)
{
...
void Settings::setString(const char* id, const String& value) noexcept(false)
{
...
void Settings::setBoolList(const char* id, const std::vector<bool>& values) noexcept(false)
{
...
void Settings::setIntList(const char* id, const std::vector<int>& values) noexcept(false)
{
...
void Settings::setNumberList(const char* id, const std::vector<double>& values) noexcept(false)
{
...
void Settings::setStringList(const char* id, const std::vector<String>& values) noexcept(false)
{
