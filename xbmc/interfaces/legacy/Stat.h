...
namespace XBMCAddon
{
  namespace xbmcvfs
  {
    ...
    public:
      ...
      st_mode();
#else
      inline long long st_mode() const { return st.st_mode; };
#endif
      ...
      st_ino();
#else
      inline long long st_ino() const { return st.st_ino; };
#endif
      ...
      st_dev();
#else
      inline long long st_dev() const { return st.st_dev; };
#endif
      ...
      st_nlink();
#else
      inline long long st_nlink() const { return st.st_nlink; };
#endif
      ...
      st_uid();
#else
      inline long long st_uid() const { return st.st_uid; };
#endif
      ...
      st_gid();
#else
      inline long long st_gid() const { return st.st_gid; };
#endif
      ...
      st_size();
#else
      inline long long st_size() const { return st.st_size; };
#endif
      ...
      st_atime();
#else
      // names st_atime, st_mtime and st_ctime are used by sys/stat.h
      inline long long atime() const { return st.st_atime; };
#endif
      ...
      st_mtime();
#else
      inline long long mtime() const { return st.st_mtime; };
#endif
      ...
      st_ctime();
#else
      inline long long ctime() const { return st.st_ctime; };
#endif
    };
    /// @}
  }
