...
namespace XBMCAddon
{
  namespace xbmcgui
  {
    ...
    Window::Window(bool discrim) : m_actionEvent(true), canPulse(true), existingWindow(false)
    {
      XBMC_TRACE;
    }
     ...
     */
    Window::Window(int existingWindowId) : m_actionEvent(true)
    {
      XBMC_TRACE;
