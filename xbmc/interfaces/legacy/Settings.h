...
public:
  ...
  getBool(...);
#else
  bool getBool(const char* id) noexcept(false);
#endif
  ...
  getInt(...);
#else
  int getInt(const char* id) noexcept(false);
#endif
  ...
  getNumber(...);
#else
  double getNumber(const char* id) noexcept(false);
#endif
  ...
  getString(...);
#else
  String getString(const char* id) noexcept(false);
#endif
  ...
  getBoolList(...);
#else
  std::vector<bool> getBoolList(const char* id) noexcept(false);
#endif
  ...
  getIntList(...);
#else
  std::vector<int> getIntList(const char* id) noexcept(false);
#endif
  ...
  getNumberList(...);
#else
  std::vector<double> getNumberList(const char* id) noexcept(false);
#endif
  ...
  getStringList(...);
#else
  std::vector<String> getStringList(const char* id) noexcept(false);
#endif
  ...
  setBool(...);
#else
  void setBool(const char* id, bool value) noexcept(false);
#endif
  ...
  setInt(...);
#else
  void setInt(const char* id, int value) noexcept(false);
#endif
  ...
  setNumber(...);
#else
  void setNumber(const char* id, double value) noexcept(false);
#endif
  ...
  setString(...);
#else
  void setString(const char* id, const String& value) noexcept(false);
#endif
  ...
  setBoolList(...);
#else
  void setBoolList(const char* id, const std::vector<bool>& values) noexcept(false);
#endif
  ...
  setIntList(...);
#else
  void setIntList(const char* id, const std::vector<int>& values) noexcept(false);
#endif
  ...
  setNumberList(...);
#else
  void setNumberList(const char* id, const std::vector<double>& values) noexcept(false);
#endif
  ...
  setStringList(...);
#else
  void setStringList(const char* id, const std::vector<String>& values) noexcept(false);
#endif
};
