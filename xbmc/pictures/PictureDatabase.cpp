...
void CPictureDatabase::CreateTables()
{
  ...
  m_pDS->exec("CREATE TABLE files (idFile INTEGER PRIMARY KEY AUTOINCREMENT, idPath INTEGER, strFilename TEXT, dateAdded TEXT)");

  CLog::Log(LOGINFO, "create path table");
  m_pDS->exec("CREATE TABLE path (idPath INTEGER PRIMARY KEY AUTOINCREMENT, strPath TEXT, noUpdate BOOL, idParentPath INTEGER)");

  CLog::Log(LOGINFO, "create picture table");
  m_pDS->exec("CREATE TABLE picture (idPicture INTEGER PRIMARY KEY AUTOINCREMENT, idFile INTEGER, exposureDate DATETIME, GPSLatitude DOUBLE, GPSLongitude DOUBLE)");
