...
/*!
 ...
 pictzre database.
 */
class CPictureLibraryJob : public CJob
{
public:
  virtual ~CPictureLibraryJob();
  ...
  */
  ...
  virtual bool DoWork();
  virtual const char* GetType() const { return "PictureLibraryJob"; }
...
protected:
  ...
  /*!
   ...
   \param[in] db Already open picture database to be used for interaction
   \return True if the process succeeded, false otherwise
   */
  virtual bool Work(CPictureDatabase& db) = 0;
};
