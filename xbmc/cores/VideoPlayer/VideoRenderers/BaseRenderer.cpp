                                         ...
                                         float inputFrameRatio, float zoomAmount, float verticalShift)
{
  ...
  m_destRect.x1 = static_cast<float>(MathUtils::round_int(static_cast<double>(posX + offsetX)));
  m_destRect.x2 = m_destRect.x1 + MathUtils::round_int(static_cast<double>(newWidth));
  m_destRect.y1 = static_cast<float>(MathUtils::round_int(static_cast<double>(posY + offsetY)));
