...
public:
  ...
  bool GetStreams(AudioStreamIdList* pList) const;
  bool IsRunning() const;
  bool          SetHogStatus(bool hog);
  pid_t GetHogStatus() const;
  bool          SetMixingSupport(UInt32 mix);
  bool GetMixingSupport() const;
  bool SetCurrentVolume(Float32 vol) const;
  ...
  bool SetDataSource(UInt32& dataSourceId) const;
  ...
  bool SetBufferSize(UInt32 size) const;
