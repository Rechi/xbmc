...
void CJNIXBMCNsdManagerDiscoveryListener::RegisterNatives(JNIEnv* env)
{
  ...
  if(cClass)
  {
    ...
    {
      {"_onDiscoveryStarted", "(Ljava/lang/String;)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onDiscoveryStarted)},
      {"_onDiscoveryStopped", "(Ljava/lang/String;)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onDiscoveryStopped)},
      {"_onServiceFound", "(Landroid/net/nsd/NsdServiceInfo;)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onServiceFound)},
      {"_onServiceLost", "(Landroid/net/nsd/NsdServiceInfo;)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onServiceLost)},
      {"_onStartDiscoveryFailed", "(Ljava/lang/String;I)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onStartDiscoveryFailed)},
      {"_onStopDiscoveryFailed", "(Ljava/lang/String;I)V", reinterpret_cast<void*>(&CJNIXBMCNsdManagerDiscoveryListener::_onStopDiscoveryFailed)},
    };
