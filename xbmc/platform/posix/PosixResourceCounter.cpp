...
double CPosixResourceCounter::GetCPUUsage()
{
  ...
  {
    double dElapsed = ( (static_cast<double>(tmNow.tv_sec) + static_cast<double>(tmNow.tv_usec) / 1000000.0) -
                 (static_cast<double>(m_tmLastCheck.tv_sec) + static_cast<double>(m_tmLastCheck.tv_usec) / 1000000.0) );
    ...
    if (dElapsed >= 3.0)
    {
      ...
      {
        double dUser = ( (static_cast<double>(usage.ru_utime.tv_sec) + static_cast<double>(usage.ru_utime.tv_usec) / 1000000.0) -
                         (static_cast<double>(m_usage.ru_utime.tv_sec) + static_cast<double>(m_usage.ru_utime.tv_usec) / 1000000.0) );
        double dSys  = ( (static_cast<double>(usage.ru_stime.tv_sec) + static_cast<double>(usage.ru_stime.tv_usec) / 1000000.0) -
